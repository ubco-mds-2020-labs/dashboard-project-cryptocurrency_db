...
#(Akshita)
#/Users/user/Desktop/
source1 = pd.read_csv("data/processed_data/price.csv", index_col=0)
crypto_usd_df = pd.read_csv("data/raw_data/crypto_usd.csv")
usd_exchange_rate_df = pd.read_csv("data/raw_data/usd_exchange_rate.csv")
source3 = pd.read_csv("data/processed_data/data3.csv")
